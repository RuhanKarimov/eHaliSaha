...
$ok = $false
$ping = "docker.internal:8080/api/public/ping"
...
Write-Host "[ui check] docker.internal:8080/ui/login.html?role=OWNER"
ExecSelenium "curl -sS -I 'docker.internal:8080/ui/login.html?role=OWNER' || true" | ForEach-Object { Write-Host $_ }
